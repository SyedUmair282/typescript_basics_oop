...
//Not in typescript but Java ma satic class inherit nhi hoti.
// class Static_class{
...
var Mobile = /** @class */ (function () {
    ...
    Mobile.prototype.setter = function (model, company, color, camera) {
        this.model = model;
        this.company = company;
        this.color = color;
        this.camera = camera;
    };
    Mobile.prototype.getter = function (model, company, color, camera) {
...
var Samsung = /** @class */ (function (_super) {
    ...
    Samsung.prototype.processing = function () {
...
var Nokia = /** @class */ (function (_super) {
    ...
    Nokia.prototype.processing = function () {
        console.log("Process is on fire");
    };
    Nokia.os = 'windows';
    return Nokia;
